...
impl<'a> FrameBuffer<'a> {
    ...
    pub fn format(&self) -> c_camera::pixformat_t {
        unsafe { (*self.fb).format }
    }

    pub fn timestamp(&self) -> c_camera::timeval {
...
pub struct CameraSensor<'a> {
    sensor: *mut c_camera::sensor_t,
    _p: PhantomData<&'a c_camera::sensor_t>,
}
...
impl<'a> CameraSensor<'a> {
    ...
    pub fn set_pixformat(&self, format: c_camera::pixformat_t) -> Result<(), EspError> {
        esp!(unsafe { (*self.sensor).set_pixformat.unwrap()(self.sensor, format) })
    }
    pub fn set_framesize(&self, framesize: c_camera::framesize_t) -> Result<(), EspError> {
    ...
    pub fn set_gainceiling(&self, gainceiling: c_camera::gainceiling_t) -> Result<(), EspError> {
...
impl<'a> Camera<'a> {
    ...
    pub fn sensor(&self) -> CameraSensor<'a> {
        CameraSensor {
            sensor: unsafe { c_camera::esp_camera_sensor_get() },
            _p: PhantomData,
        }
    }
}
